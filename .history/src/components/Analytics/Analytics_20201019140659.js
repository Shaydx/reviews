  ...
  render() {
    return (
      <div id="analytics" className="container">
        <div className="logo">
          {this.state.organisationProfile === null ? <Skeleton width={250} height={100} /> : <img src={this.state.organisationProfile.logoLink} alt={this.state.organisationProfile.reviewName + ' Logo'} />}
        </div>
