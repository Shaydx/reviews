  ...
  render() {
    return (
      <div id="analytics" className="container">
        <div className="logo">
          {this.state.organisationProfile === null ? <Skeleton width={250} height={100} /> : <img className="company-logo" src={this.state.organisationProfile.logoLink} alt={this.state.organisationProfile.reviewName + ' Logo'} />}
        </div>
        <div className="analytics">
          ...
          <div className="spread">
            ...
            <div className="passive">{this.state.analytics === null ? <Skeleton /> : this.state.analytics.spread.passives}</div>
            <div className="promoters">{this.state.analytics === null ? <Skeleton /> : this.state.analytics.spread.promoters}</div>
          </div>
        </div>
      </div>
    );
