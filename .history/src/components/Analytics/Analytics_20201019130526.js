...
// Method
import { orgIdByReviewName } from "../../integrations/orgIdByReviewName";
import { organisationDetails } from "../../integrations/organisationDetails";
...
class Analytics extends Component {
  ...
  componentDidMount() {
    ...
    orgIdByReviewName(reviewName, (orgId) => {
      this.setState({
        orgId: orgId,
      });
    });
