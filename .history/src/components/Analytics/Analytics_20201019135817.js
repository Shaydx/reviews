      ...
      <div id="analytics" className="container">
        ...
        <div className="analytics">
          ...
          <div className="spread">
            ...
            <div className="passive">{this.state.analytics === null ? <Skeleton /> : this.state.analytics.passives.detractors}</div>
            <div className="promoters">{this.state.analytics === null ? <Skeleton /> : this.state.analytics.promoters.detractors}</div>
          </div>
        </div>
      </div>
    );
