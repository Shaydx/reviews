...
import { getResponsesFromOrganisation } from "../../integrations/campaginIdByOrgId";
...
export class Response extends Component {
  ...
  async componentDidMount() {
    ...
    const responses = await getResponsesFromOrganisation(orgId);

    this.setState({
      orgId: orgId,
      responsesFromOrganisation: responses,
    });
